  ...
  return (
    <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
      <div>
        ...
        <h2 className="mt-2 text-2xl font-semibold text-white">Upload, clean, and query a CSV</h2>
        <p className="mt-1 max-w-3xl text-sm leading-6 text-slate-300">
          Step through upload, cleaning evidence, and a suggested SQL query before you hand the dataset off to dashboards
          or automation.
        </p>
      </div>
